...
const Participants = () => {
  ...
  // Compact horizontal card component for list view
  ...
  // Grid card component with lazy loading
  ...
  return (
    ...
    >
      <main className="flex flex-col h-full">
        <h1 className="sr-only">Tournament Participants</h1>
        ...
        <div className="flex items-center justify-between flex-shrink-0 bg-background/95 backdrop-blur-md border-b border-border p-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              ...
              <span>{sortOrder === 'best' ? 'Best → Worst' : 'Worst → Best'}</span>
            </Button>
